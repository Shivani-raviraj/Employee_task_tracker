...
<%
    ...
    try {
        ...
        e.printStackTrace();
        out.println("<p>Error retrieving user information. Please try again later.</p>");
    }
%>
<!DOCTYPE html>
<html>
    ...
    <div class="container">
        ...
        <table>
            ...
            <%
                    ...
                    e.printStackTrace();
                    out.println("<tr><td colspan='7'>Error retrieving tasks. Please try again later.</td></tr>");
                }
            %>
        </table>
